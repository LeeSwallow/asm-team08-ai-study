...
SAFE_DIALOGUE_PADDING = {
    ...
    "그 이상은 추측하고 싶지 않습니다",
    "22시요",
    "그 부분은 분명히 말씀드릴 수 있어요",
    "기억나는 건 거기까지예요",
    "제가 드릴 수 있는 대답은 거기까지예요",
    "그렇게 넓게 물으시면 제가 뭘 더 말해야 할지 모르겠군요",
    "기억나는 것만 말씀드리겠습니다",
    "그 질문은 너무 넓습니다",
    "핵심만 물어보시죠",
    "잠깐만요. 그렇게 몰아가듯 물으시면 대답하기 어렵습니다",
    "그 단서 얘기를 제게 돌리셔도, 제가 직접 본 것 이상은 말할 수 없습니다",
    "그 단서만으로 단정할 수는 없습니다",
    ...
    "그만하시죠. 지금 제 대답은 달라지지 않습니다",
    "다만 같은 말을 반복하라는 식의 질문은 불편하군요",
    "방금 말씀드린 범위를 넘겨 단정하라고 하시면 곤란합니다",
    "알겠습니다",
    "지금 공개적으로 말할 수 있는 건 더 돌리지 않고 말씀드리겠습니다",
    "공개된 범위에서 더 돌려 말하지 않겠습니다",
    "아까도 말했습니다",
    "그 시간만큼은 분명히 기억합니다",
    "잠깐만요, 시간을 흐리려는 게 아닙니다",
    "그 증거가 그렇게 이어진다면 제 말이 흔들리는 건 인정합니다",
