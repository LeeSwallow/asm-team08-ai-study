...
class CaseKnowledgeService:
        ...
        return {
            "baseline": {
                **base,
                ...
                "overlay": {
                    ...
                    "tone": "controlled",
                    "voice": "차분하게 선을 긋는 말투",
                    "styleDirectives": ["controlled", "concise"],
                    "tensionLevel": "low",
                    "pressureState": "normal",
                    "emotionalState": "neutral",
                },
            ...
            "defensive": {
                **base,
                ...
                "evasiveness": 0.55,
                "hesitation": "medium",
                "sample": "그렇게 단정하실 일은 아닙니다.",
                "overlay": {
                    "id": f"pv_{suspect_id}_defensive",
                    "label": "defensive",
                    "tone": "defensive",
                    "voice": "방어적이지만 통제된 말투",
                    "styleDirectives": ["defensive", "avoid confession", "answer from visible alibi"],
                    "tensionLevel": "medium",
                    "pressureState": "pressed",
            ...
            "pressed": {
                **base,
                ...
                "label": "pressed",
                "tensionLevel": "high",
                "tensionLevels": ["high", "critical"],
                "pressureState": "pressed",
                "pressureStates": ["pressed", "broken"],
                "emotionalState": "shocked",
                "emotionalStates": ["anxious", "shocked", "angry", "breakdown"],
                "minTensionScore": 70,
                ...
                "overlay": {
                    ...
                    "label": "pressed",
                    "tone": "pressed",
                    "voice": "짧고 날카롭게 방어하는 말투",
                    "styleDirectives": ["curt", "pressured", "stay within visible case context"],
                    "tensionLevel": "high",
                    "pressureState": "pressed",
                    "emotionalState": "shocked",
                },
    ...
    def _active_persona_overlay(
        ...
        selected = "baseline"
        if tension in {"high", "critical"} or pressure >= 70 or pressure_label == "broken":
            selected = "pressed"
