...
from app.core.guard import contains_secret
from app.core.llm import deterministic_clip, get_llm, llm_status
from app.domain.dialogue_intent import classify_dialogue_intent, normalize_dialogue_text
from app.prompts.dialogue import DIALOGUE_SYSTEM_PROMPT
from app.schemas.agents import CharacterAgentInput, DraftCharacterReply
from app.schemas.common import PersonaOverlay, PersonaVariant
...
class CharacterAgent:
    def run(self, agent_input: CharacterAgentInput) -> DraftCharacterReply:
        ...
        try:
            ...
            text = get_llm().complete(prompt, seed_text=seed, max_length=payload.style.maxLength)
